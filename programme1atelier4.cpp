...
using namespace std;
      ...
      //  la somme des deux nombres complexes complex1 et complex2
	   ...
	   //  la soustraction des deux nombres complexes complex1 et complex2     
             a = complex1.real - complex2.real;
             b = complex1.imaginaire - complex2.imaginaire;
            cout << "La soustraction est "<< a << " - " << b << "i";
       
	   //  la multiplication des deux nombres complexes complex1 et complex2     
             a = complex1.real * complex2.real;
             b = complex1.imaginaire * complex2.imaginaire;
            cout << "La multiplication est "<< a << " * " << b << "i";
